...
### 3. 기본 여백을 제거하여 작성된 CSS를 더 잘 제어할 수 있다
...
### 4. list를 role값으로 갖는 ul, ol 요소의 기본 목록 스타일을 제거한다
...
### 5. 제목에 대한 text-wrap을 balance로 설정한다
...
### 6. 클래스가 없는 기본 a 태그 요소는 기본 스타일을 가져온다
...
### 7. input 및 button 항목들이 글꼴을 상속하도록 한다
...
### 8. 행 속성이 없는 textarea가 너무 작지 않도록 한다
...
### 9. 고정된 모든 항목에는 여분의 스크롤 여백이 있어야 한다
